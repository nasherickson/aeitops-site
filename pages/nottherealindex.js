...
export default function Home() {
  ...
  return (
    <div className="bg-black text-white min-h-screen font-sans p-8">
      <header className="fixed top-0 left-0 w-full z-0 backdrop-blur-2xl bg-black/70 h-[30rem] flex flex-col justify-center items-center">
        <img
          src="/aeitops.png"
          alt="AE-iT.OPS Logo"
          className={`w-80 h-80 mb-4 transition-all duration-500 ${
